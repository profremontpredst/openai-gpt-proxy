...
⚡ Для озвучки ElevenLabs v3:
- Добавляй короткие паузы: <break time="200ms"/>.
- Используй эмо-маркеры: [улыбаясь], [с энтузиазмом], [спокойно].
- Делай акценты: <emphasis>...<emphasis/>.
- Пиши так, чтобы вслух это звучало естественно и разговорно.
`;
